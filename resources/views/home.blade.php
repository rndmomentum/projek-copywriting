                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                <select class="form-control" name="emotion" required>
                                    ...
                                    <option value="e1">Need of Guarantee</option>
                                    <option value="e2">Need of Variety</option>
                                    <option value="e3">Need of Excellent</option>
                                    <option value="e4">Need of Recognition</option>
                                    <option value="e5">Need of Achievement</option>
                                    <option value="e6">Need of Love</option>
                                    <option value="e7">Need of Growth</option>
                                    <option value="e8">Need of Contribution</option>
                                </select>
                            </div>
                        </div>
